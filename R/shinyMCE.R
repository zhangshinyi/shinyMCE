...
tinyMCE <- function(inputId, content, options = NULL){
  tagList(
    singleton(tags$head(tags$script(src = "https://cxodirisdevappstr.blob.core.windows.net/$web/tinymce5/tinymce/js/tinymce/tinymce.min.js", referrerpolicy="origin"))),
